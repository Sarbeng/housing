        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('rentalAgreement.index')"
                        :active="request()->routeIs('rentalAgreement.index')">
...
<x-nav-link :href="route('feesAllocation.index')" :active="request()->routeIs('feesAllocation.index')">
    {{ __('Fee Allocation') }}
</x-nav-link>
                </div>
            </div>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.edit')">
                         ...
                         <x-dropdown-link :href="route('send.sms')">
                            {{ __('Send Messages') }}
                        </x-dropdown-link>
